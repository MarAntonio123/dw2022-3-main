        ...
        <div class="row justify-content-center">
            ...
            <form action="" class="col-md-6 mt-4" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="dire_nombres" name="dire_nombres" value="<?php echo $fila['dire_nombres'];?>"required>
                </div>
                <div class="form-group">
                    <label for="dire_apellidos">Apellido </label>
                    <input type="text" class="form-control" id="dire_apellidos" name="dire_apellidos" value="<?php echo $fila['dire_apellidos'];?>">
                </div>
                <div class="form-group">
                    <label for="dire_img">Imagen del Director</label>
                    <input type="text" class="form-control" id="dire_img" name="dire_img" value="<?php echo $fila['dire_img'];?>">
                </div>
                <div class="form-group">
                    <label for="dire_pais">Pais del director</label>
                    <input type="text" class="form-control" id="dire_pais" name="dire_pais" value="<?php echo $fila['dire_pais'];?>">
                </div>
                    <div class="form-group">
                        <input type="submit" value="actualizardire" class="btn btn-primary" name="actualizardire">
                    </div>
            </form>
            <?php
                if(isset($_POST['actualizardire'])){
                    ...
                    dire_nombres   = '{$dire_nombres}',
                    dire_apellidos = '{$dire_apellidos}',
                    dire_img       = '{$dire_img}',
                    dire_pais      = '{$dire_pais}' WHERE dire_id = {$dire_id}";
